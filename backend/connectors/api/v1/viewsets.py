...
class NewConnectorsdvsdvdbrViewSet(BaseConnectorViewSet):
    TOKEN = settings.CONNECTOR_NEW_CONNECTORSDVSDVDBR_TOKEN
    BASE_URL = "https://api.asda.com"
    AUTH_TYPE = "bearer"
    IDENTIFIER = "CONNECTOR_NEW_CONNECTORSDVSDVDBR"

    @action(detail=False, methods=["get"], url_path="testing")
    def testing(self, request, *args, **kwargs):
        params = request.query_params
        payload = request.data
        data = self._api_call(
            "/testing/", request_type="get", payload=payload, params=params
        )
